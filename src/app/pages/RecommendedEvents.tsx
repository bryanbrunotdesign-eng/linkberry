      ...
      <div className="bg-white border-b border-[#E2E8F0] fixed top-0 left-0 right-0 z-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 pt-4 pb-4">
          <div className="flex items-center justify-between mb-4">
            ...
            <h1 className="text-2xl font-['Rethink_Sans',sans-serif] font-bold text-[#0D1117]">Recommended Events</h1>
            <div className="w-9" />
          </div>
          <p className="text-center text-sm text-[#718096]">
            Your curated list of events for the next 2 months!
          </p>
        </div>
      </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          <div className="space-y-4">
            {recommendedEvents.map((event) => (
              <EventCard key={event.id} {...event} variant="full-width" badge="recommended" />
            ))}
          </div>
        </div>
      </div>
